...
def load_data(train_path):
    #提取用户交互记录数据
    train_data = pd.read_csv(train_path, sep="\t", engine="python", dtype={"itemid": int}) # 文件包含表头，需要去掉names参数
...
if __name__ == "__main__":
    train_data_path = "./2.BasicAlgorithm/Match/data/ratings_final.txt"
    item_sim_save_path = "./2.BasicAlgorithm/Match/data/item_sim_dict.txt"
